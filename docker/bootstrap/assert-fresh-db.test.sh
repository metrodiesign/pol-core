...
grep -qE 'migration history must contain exactly 17 expected migrations' docker/bootstrap/assert-fresh-db.sql \
...
grep -qE '20260816162306_MicrosoftOidcProviderDiscriminator' docker/bootstrap/assert-fresh-db.sql \

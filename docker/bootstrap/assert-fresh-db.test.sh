...
grep -qE 'migration history must contain exactly 19 expected migrations' docker/bootstrap/assert-fresh-db.sql \
...
grep -qE '20260817172338_MerchantPaymentCapabilityControlPlane' docker/bootstrap/assert-fresh-db.sql \

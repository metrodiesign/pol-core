...
internal sealed class AdminPaymentsApprovalExecutor(
    ...
    ControlPlanePaymentAuthorizationSqlLockManager authorizationLocks) : IApprovalDecisionExecutor
{
        ...
        string? version)
    {
        ...
        db.GovernanceOutboxMessages.Add(GovernanceOutboxMessage.Create(
            message.EventId, GovernanceScopeKind.Merchant, decision.MerchantId,

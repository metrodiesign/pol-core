...
namespace Persistence.ControlPlane.Vault;
...
/// application code inside ONE <see cref="CommerceDbContext"/> transaction (not
...
internal sealed class VaultAuditAppender(ControlPlaneDbContext db, ISecurityTelemetry telemetry) : IVaultAuditAppender
{

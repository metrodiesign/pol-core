...
internal sealed class UserConfiguration(IMerchantFilterContext context) : IEntityTypeConfiguration<User>
{
...
internal sealed class MerchantUserInvitationConfiguration(IMerchantFilterContext context)
...
internal sealed class AdminUserOperationRecordConfiguration(IMerchantFilterContext context)
...
internal sealed class MerchantUserManagementAuditConfiguration(IMerchantFilterContext context)

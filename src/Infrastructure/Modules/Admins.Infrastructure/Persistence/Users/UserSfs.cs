...
/// <see cref="RoleSfs"/>. Deny-by-default whitelists (<see cref="FrozenDictionary{TKey,TValue}"/> /
...
/// (<see cref="ArgumentException"/>) rather than a 409/500 (REQ-1.7). Unlike RoleSfs, EVERY ordering is
/// closed with a final <c>ThenBy(Id)</c> so paging stays stable when a sorted column collides (REQ-1.3).
/// </summary>
public static class UserSfs
{

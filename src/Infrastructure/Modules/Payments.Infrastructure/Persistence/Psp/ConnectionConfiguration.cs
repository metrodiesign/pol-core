...
public sealed class ConnectionConfiguration : IEntityTypeConfiguration<Connection>
{
    public void Configure(EntityTypeBuilder<Connection> builder)
    {
        ...
        builder.Property(x => x.Metadata).IsUnicode();
        ...
        builder.HasIndex(x => new { x.MerchantId, x.ActiveSecretVersionId });
        builder.HasIndex(x => new { x.MerchantId, x.PendingSecretVersionId });

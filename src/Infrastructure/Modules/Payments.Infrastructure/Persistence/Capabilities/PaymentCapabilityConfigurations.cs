...
public sealed class PaymentAuthorizationStateConfiguration(string? providerName = null)
    : IEntityTypeConfiguration<PaymentAuthorizationState>
{
    ...
    {
        var singletonId = string.Equals(providerName, "Microsoft.EntityFrameworkCore.Sqlite", StringComparison.Ordinal)

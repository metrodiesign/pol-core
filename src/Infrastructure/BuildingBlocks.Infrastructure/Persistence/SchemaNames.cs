...
public static class SchemaNames
{
    ...
    /// <summary>Account-owned identity and BFF metadata.</summary>
    public const string Acct = "acct";

    /// <summary>Account access grants and platform/system scope assignments.</summary>
    public const string Access = "access";

    /// <summary>Checkout capabilities owned by the Checkout module.</summary>
    public const string Checkout = "checkout";

    /// <summary>Orders owned by the Order module in the target model.</summary>
    public const string Ord = "ord";

    /// <summary>OpenIddict's single owner for authorization, code, grant and token state.</summary>

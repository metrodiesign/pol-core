...
internal sealed class ControlPlaneUnitOfWork : IUnitOfWork
{
    ...
    {
        // Composed Control Plane operations may call a second adapter that shares this UoW. Reuse the
        // ambient transaction rather than attempting a nested BeginTransaction on the same connection;
        // the outer owner remains responsible for commit/rollback and execution-strategy retries.

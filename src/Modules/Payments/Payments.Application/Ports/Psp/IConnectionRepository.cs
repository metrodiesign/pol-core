...
namespace Payments.Application.Ports.Psp;
...
public interface IConnectionRepository
{
    ...
    Task<Connection?> GetAsync(Guid merchantId, Code psp, CancellationToken cancellationToken);
    ...
    /// </summary>
    Task<Connection?> GetByIdAsync(Guid pspConnectionId, CancellationToken cancellationToken);
    ...
    Task<IReadOnlyList<Connection>> ListByTenantAsync(Guid merchantId, CancellationToken cancellationToken);
}

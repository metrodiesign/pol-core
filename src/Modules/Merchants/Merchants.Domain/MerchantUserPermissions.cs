...
/// SeedData migration seeds <c>merch.MerchantUserPermissions</c> / <c>MerchantUserPermissionGroups</c> (with
...
public static class MerchantUserPermissions
{
    ...
    /// <summary>All valid permission keys — the parity reference and the role-grant catalog.</summary>

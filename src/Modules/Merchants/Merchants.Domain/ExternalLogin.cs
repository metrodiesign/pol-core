...
/// <summary>Maps a Google identity to exactly one <see cref="MerchantUser"/>. Keyed by
...
public sealed class ExternalLogin : Entity<Guid>
{
    ...
    /// <summary>Links a Google subject to a <see cref="MerchantUser"/> at registration. <paramref name="provider"/>

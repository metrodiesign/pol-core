...
/// </summary>
public sealed class MerchantUserRegistrationConsumer : INotificationHandler<MerchantUserRegistrationSubmitted>
{
    private readonly IRegistrationNoticeWriter _notices;
    private readonly IClock _clock;

    public MerchantUserRegistrationConsumer(IRegistrationNoticeWriter notices, IClock clock)
    {
        _notices = notices;
        _clock = clock;
    }

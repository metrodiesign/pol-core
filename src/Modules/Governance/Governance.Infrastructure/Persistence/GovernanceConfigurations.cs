...
namespace Governance.Infrastructure.Persistence;
...
public sealed class ApprovalRequestConfiguration : IEntityTypeConfiguration<ApprovalRequest>
{
    public void Configure(EntityTypeBuilder<ApprovalRequest> builder)
    {
        ...
        builder.Property(x => x.MakerId).IsRequired();
...
public sealed class OperationRecordConfiguration : IEntityTypeConfiguration<OperationRecord>
{
...
public sealed class AuditHeadConfiguration : IEntityTypeConfiguration<AuditHead>
{
...
public sealed class GovernanceOutboxMessageConfiguration : IEntityTypeConfiguration<GovernanceOutboxMessage>
{

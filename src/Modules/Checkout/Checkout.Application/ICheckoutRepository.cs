...
/// adapter resolves it against the shared producer data plane; all access is tenant-scoped by the
...
public interface ICheckoutRepository
{
    ...
    /// <summary>Loads a session by id, or <c>null</c> when none exists in the caller's tenant.</summary>

...
/// </summary>
public static class AdminAccountSfs
{
    ...
    public static IQueryable<AdminAccount> ApplyFilters(
        this IQueryable<AdminAccount> query, IReadOnlyList<FilterOption> filters, ILogger? logger = null)
    {
    ...
    private static IQueryable<AdminAccount> ApplyFilter(IQueryable<AdminAccount> q, FilterOption f)
    {
    ...
    public static IQueryable<AdminAccount> ApplySort(
        this IQueryable<AdminAccount> query, IReadOnlyList<SortOption> sort, ILogger? logger = null)
    {
        IOrderedQueryable<AdminAccount>? o = null;
    ...
    public static IQueryable<AdminAccount> ApplySearch(this IQueryable<AdminAccount> query, SearchOption? search)
    {
    ...
    private static AdminTier ParseTier(string value) => value.ToLowerInvariant() switch
    {
        "super" => AdminTier.Super,
        "scoped" => AdminTier.Scoped,

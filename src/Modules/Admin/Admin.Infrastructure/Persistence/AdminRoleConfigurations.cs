...
// Control-plane tables: NO tenant RLS predicate, granted to pol_admin only (see AddAdminRoleRbacTables). The
...
public sealed class AdminPermissionGroupConfiguration : IEntityTypeConfiguration<AdminPermissionGroup>
{
    ...
    {
        builder.ToTable("AdminPermissionGroups");

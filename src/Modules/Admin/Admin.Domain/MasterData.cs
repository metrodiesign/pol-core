...
{
    // Code lands nowhere in a route path, but stays a URL-safe slug for parity with AdminRole.Code.
    ...
    protected MasterData(Guid id, string code, string name) : base(id)
    {
...
public sealed class Position : MasterData
{
    private Position() { }

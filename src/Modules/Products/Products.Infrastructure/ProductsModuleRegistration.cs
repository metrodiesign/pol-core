...
public static class ProductsModuleRegistration
{
    ...
    /// assembly to <c>ModuleAssemblies.Producer</c> so <c>ProductConfiguration</c> is picked up at
    /// model-build time. Repository is Scoped (depends on the Scoped <c>ProducerDbContext</c>).
    /// </summary>

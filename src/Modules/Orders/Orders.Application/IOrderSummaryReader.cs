...
/// the customer is anonymous and must not learn the tenant. <see cref="ExpiresAtUtc"/> lets the host decide
/// 410 Gone vs 200.</summary>
public sealed record OrderSummary(
    Guid OrderId, long AmountMinorUnits, string Currency, string Status, Guid? PaymentSessionId, DateTime ExpiresAtUtc);

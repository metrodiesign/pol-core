...
public static class AuditAction
{
    ...
    public const string AccountSessionsRevoked = "account-sessions-revoked";
    public const string MerchantAccessChanged = "merchant-access-changed";
    public const string PlatformAccessChanged = "platform-access-changed";

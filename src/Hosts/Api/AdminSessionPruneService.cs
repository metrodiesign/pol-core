...
internal sealed class AdminSessionPruneService : BackgroundService
{
    ...
    private readonly ILogger<AdminSessionPruneService> _logger;

    public AdminSessionPruneService(IServiceScopeFactory scopeFactory, IClock clock, ILogger<AdminSessionPruneService> logger)
    {
        ...
        try
        {
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                try
                {
                    ...
                    var store = scope.ServiceProvider.GetRequiredService<IAdminSessionStore>();

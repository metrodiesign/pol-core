...
internal static class AdminSessionTokens
{
    ...
    /// <summary>SHA-256 of the token string — the value persisted as <c>AdminSessions.TokenHash</c>.</summary>
...
/// </summary>
internal sealed class AdminSessionCookies
{
    ...
    public AdminSessionCookies(IOptions<AdminSessionOptions> options, IHostEnvironment environment)
    {

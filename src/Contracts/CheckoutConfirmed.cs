...
/// <summary>One purchased line of a confirmed checkout (insurance-pivot REQ-6/7) — the commercial +
...
/// the optional notification recipient so the created order can notify the customer. <see cref="Lines"/>
...
public sealed record CheckoutConfirmed(
    ...
    string? Recipient,
    DateTime OccurredAt,
    IReadOnlyList<CheckoutConfirmedLine> Lines) : INotification
{

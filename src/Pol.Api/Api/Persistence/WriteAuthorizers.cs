...
using IdentityAccount = Accounts.Domain.Account;
using LoginAccount = Accounts.Domain.LoginAccount;
using EmployeeAccount = Accounts.Domain.Employee;
using AgentAccount = Accounts.Domain.Agent;
...
using PlatformAccess = Access.Domain.PlatformAccess;
using PlatformAccessRole = Access.Domain.PlatformAccessRole;
using SystemClientScope = Access.Domain.SystemClientScope;
using MerchantAccessMethod = Access.Domain.MerchantAccessMethod;
using OpenIddictEntityFrameworkCoreApplication = OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreApplication;
using OpenIddictEntityFrameworkCoreAuthorization = OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreAuthorization;
using OpenIddictEntityFrameworkCoreScope = OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreScope;
using OpenIddictEntityFrameworkCoreToken = OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreToken;
...
/// <summary>
/// Merchant-request capability: constructs <c>MerchantUserDbContext</c>/<c>CommerceDbContext</c> per
...
internal sealed class MerchantRequestWriteAuthorizer : IWriteAuthorizer
{
    ...
    [
        ...
        typeof(PaymentLink), typeof(PaymentLinkReplay),
        typeof(PaymentSession), typeof(InboundWebhookEvent), typeof(Connection), typeof(IdempotencyRecord), typeof(OutboxMessage),
        typeof(Transaction), typeof(TransactionEvent),
        typeof(global::Notifications.Domain.Notification), typeof(global::Notifications.Domain.TemplateVersion),
        typeof(global::Notifications.Domain.Delivery), typeof(global::Notifications.Domain.DeliveryAttempt),
        typeof(global::Notifications.Domain.NotificationInboxMessage), typeof(global::Notifications.Domain.NotificationReviewNote),
...
internal sealed class AdminApprovalWriteAuthorizer : IWriteAuthorizer
{
    ...
    [
        ...
        (typeof(Branch), WriteOperation.Insert),
        (typeof(Branch), WriteOperation.Update),
        (typeof(Sale), WriteOperation.Insert),
        (typeof(Sale), WriteOperation.Update),
        ...
        (typeof(OrderItem), WriteOperation.Update),
        (typeof(OrderItem), WriteOperation.Delete),
        (typeof(PaymentLink), WriteOperation.Insert),
        (typeof(PaymentLink), WriteOperation.Update),
        (typeof(PaymentLinkReplay), WriteOperation.Insert),
        ...
        (typeof(Transaction), WriteOperation.Insert),
        (typeof(Transaction), WriteOperation.Update),
        (typeof(TransactionEvent), WriteOperation.Insert),
        (typeof(global::Notifications.Domain.Delivery), WriteOperation.Update),
        (typeof(global::Notifications.Domain.DeliveryAttempt), WriteOperation.Insert),
...
internal sealed class ControlPlaneAdminWriteAuthorizer : IWriteAuthorizer
{
    ...
    [
        ...
        typeof(MerchantProviderAccountMethodOption), typeof(MerchantPaymentMethod),
        typeof(MerchantUserPaymentMethod), typeof(VaultSecretBlob), typeof(VaultSecretVersion),
        typeof(VaultRevealAudit), typeof(ProvisioningAudit),
        typeof(OpenIddictEntityFrameworkCoreApplication), typeof(OpenIddictEntityFrameworkCoreAuthorization),
    ...
    [
        ...
        (typeof(OpenIddictEntityFrameworkCoreAuthorization), WriteOperation.Update),
        (typeof(OpenIddictEntityFrameworkCoreScope), WriteOperation.Insert),
        (typeof(OpenIddictEntityFrameworkCoreScope), WriteOperation.Update),
        (typeof(OpenIddictEntityFrameworkCoreToken), WriteOperation.Insert),
        (typeof(OpenIddictEntityFrameworkCoreToken), WriteOperation.Update),
    ];

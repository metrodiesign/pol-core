...
internal sealed class OutboxDispatcher : BackgroundService
{
    ...
    private async Task DispatchBatchAsync(CancellationToken cancellationToken)
    {
        ...
        {
            var db = leaseScope.ServiceProvider.GetRequiredService<MerchantRuntimeDbContext>();
        ...
        // in-process consumers (e.g. OrderPaidConsumer writing shop.Orders) run scoped. The MerchantId is
        // trustworthy: the BLOCK-after-insert predicate guaranteed it matched the writer's SESSION_CONTEXT.

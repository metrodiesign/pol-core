...
// Runtime (scalar-only) mapping — mirrors Orders.Infrastructure.Lines.LineConfiguration exactly for
...
internal sealed class LineConfiguration(MerchantRuntimeDbContext context) : IEntityTypeConfiguration<OrderLine>
{
    public void Configure(EntityTypeBuilder<OrderLine> builder)
    {
        ...
        TenantKeyDescriptor.Require(builder.Metadata, nameof(OrderLine.MerchantId));

...
/// the PSP webhook (merchant resolved from the connection id) and the outbox dispatcher (merchant taken
/// from the message). HTTP requests never use this — their actor comes from the verified session.
/// <para>

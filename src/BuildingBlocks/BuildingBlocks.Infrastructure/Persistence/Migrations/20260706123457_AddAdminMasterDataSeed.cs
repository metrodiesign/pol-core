...
namespace BuildingBlocks.Infrastructure.Persistence.Migrations
{
    ...
    public partial class AddAdminMasterDataSeed : Migration
    {
        ...
        // Ids and the AdminAccount FKs stay stable. They are RFC-4122-well-formed (version nibble = 4,
        // variant nibble = 8: "…-4000-8000-…") yet namespaced by table for readability:
        //   Positions a1…  Offices b2…  Levels c3…  Divisions d4…  (row counter in the final group).

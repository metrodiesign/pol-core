...
namespace BuildingBlocks.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260730081227_CheckoutChainDocumentFields")]
    partial class CheckoutChainDocumentFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Products.Domain.Product", b =>
                {
                    ...
                    b.Property<decimal?>("CommissionAmountAmount")
                        .HasPrecision(19, 4)
                        .HasColumnType("decimal(19,4)")
                        .HasColumnName("CommissionAmount");

                    b.Property<string>("CommissionAmountCurrency")
                        .HasMaxLength(3)
                        .IsUnicode(false)
                        .HasColumnType("char(3)")
                    ...
                    b.Property<string>("PolicyBranch")
                        .HasMaxLength(250)
                    ...
                    b.Property<string>("PolicySequenceNo")
                        .HasMaxLength(30)
                        .IsUnicode(false)
                    ...
                    b.Property<string>("ReferencePre")
                        .HasMaxLength(20)
                        .IsUnicode(false)
                        .HasColumnType("varchar(20)");
                    ...
                    b.Property<string>("StampCurrency")
                        .HasMaxLength(3)
                        .IsUnicode(false)
                        .HasColumnType("char(3)")
                        .IsFixedLength();
                    ...
                    b.Property<decimal?>("TaxVatAmount")
                        .HasPrecision(19, 4)
                        .HasColumnType("decimal(19,4)");

                    b.Property<string>("TaxVatCurrency")
                        .HasMaxLength(3)
                        .IsUnicode(false)
                        .HasColumnType("char(3)")
                        .IsFixedLength();

                    b.ComplexProperty(typeof(Dictionary<string, object>), "TotalPremium", "Products.Domain.Product.TotalPremium#Money", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.HasIndex(new[] { "MerchantId", "IsActive" }, "IX_Products_MerchantId_IsActive");

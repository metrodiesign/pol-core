...
namespace BuildingBlocks.Infrastructure.Persistence.Migrations
{
    ...
    public partial class AddProducerOutboxAdminGrant : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // bypass skips PREDICATES, not table GRANTs — and VCentralPay.OutboxMessages only granted INSERT to pol_app
            ...
            migrationBuilder.Sql("GRANT INSERT ON VCentralPay.OutboxMessages TO pol_admin;");
        }

        /// <inheritdoc />
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("REVOKE INSERT ON VCentralPay.OutboxMessages FROM pol_admin;");
        }
    }
}

...
- `ILegacyPaymentRemediation`
  (`src/Modules/Payments/Payments.Application/Capabilities/LegacyPaymentRemediation.cs`)
...
- guard `legacy_snapshot_blocked`:
  `src/Persistence/Persistence.MerchantRuntime/Payments/AdminPaymentsControlStore.cs:669` (credential),
  `:834` (environment)

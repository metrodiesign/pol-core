...
> As-built 2026-08-13. แหล่งความจริง: `src/Modules/Levels/**`,
...
`20260810074055_AdminConsoleResourceVersions` เพิ่ม `Version`; ไม่มี migration หลังจากนี้แก้ shape ของ Levels.

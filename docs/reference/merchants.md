...
3. Admin เรียก `POST /api/v1/merchants/users/{merchantUserId}/approve` (หรือ canonical `POST /api/v1/agent-registrations/{id}/attempts/{attemptId}/approve`) พร้อม `merchantCode` และ role codes.

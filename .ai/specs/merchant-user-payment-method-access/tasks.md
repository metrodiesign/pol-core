...
- [x] 1. **Capability persistence foundation and additive expand migration**
     ...
     REQ-1 (all criteria), REQ-2.1-REQ-2.5, REQ-2.8-REQ-2.13.
...
- [x] 2. **Provider and account capability control plane with authorization locks**
     ...
     REQ-2.14-REQ-2.15, REQ-3.1-REQ-3.5, REQ-3.9-REQ-3.24. Depends on: 1.
      - deviations: none recorded — legacy corpus predates evidence v2 protocol (human checkpoint 2026-08-26)
- [x] 3. **Canonical effective resolver, options intersection and self-service reads**
     ...
     REQ-5 (all criteria), REQ-6.4-REQ-6.5, REQ-6.8-REQ-6.12, REQ-6.18-REQ-6.21, REQ-6.26, REQ-9 (all criteria). Depends on: 1, 2.
      - deviations: none recorded — legacy corpus predates evidence v2 protocol (human checkpoint 2026-08-26)
- [x] 4. **Merchant/User policy administration and five-query contract**
     ...
     REQ-3.6-REQ-3.8, REQ-4 (all criteria), REQ-6.1-REQ-6.3, REQ-6.6-REQ-6.7, REQ-6.11, REQ-6.13-REQ-6.17, REQ-6.19, REQ-6.22-REQ-6.25, REQ-6.27-REQ-6.28. Depends on: 1, 2, 3.
      - deviations: none recorded — legacy corpus predates evidence v2 protocol (human checkpoint 2026-08-26)
- [x] 5. **Order and Payment Session authorization boundary**
     ...
     REQ-7.1-REQ-7.2, REQ-7.4-REQ-7.5, REQ-7.7-REQ-7.8, REQ-7.10-REQ-7.15. Depends on: 1, 3, 4.
      - deviations: none recorded — legacy corpus predates evidence v2 protocol (human checkpoint 2026-08-26)
- [x] 6. **First-charge claim and anonymous payment enforcement**
     ...
     REQ-7.3, REQ-7.6, REQ-7.9, REQ-7.16-REQ-7.19, REQ-8 (all criteria). Depends on: 5.
      - deviations: none recorded — legacy corpus predates evidence v2 protocol (human checkpoint 2026-08-26)
- [x] 7. **Deterministic compatibility backfill, verified cutover and rollback**
     ...
     REQ-2.6-REQ-2.7, REQ-10 (all criteria). Depends on: 1-6.
      - deviations: none recorded — legacy corpus predates evidence v2 protocol (human checkpoint 2026-08-26)
- [x] 8. **Security, compatibility and acceptance assembly**
     ...
     REQ-11 (all criteria). Depends on: 1-7.
      - deviations: none recorded — legacy corpus predates evidence v2 protocol (human checkpoint 2026-08-26)

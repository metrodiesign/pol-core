...
> Status: approved (2026-08-06) — ตัดสินแล้ว: D1 = B (ชนิดใหม่ `DependencyUnavailableException` ตอบ 503), D2 = S2 (ครอบการอ่านทุกจุดของ `Persistence.MerchantRuntime` ในเส้นทางตอบคำขอ), D3 = P1 (`GET /products` ล้มทั้งคำขอ), D4 = R1 (retry อยู่นอกขอบเขต — REQ-5.4 คงไว้)

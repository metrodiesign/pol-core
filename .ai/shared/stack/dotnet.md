...
> Historical: RLS ทั้งก้อนถูกถอดแล้ว (app-layer scoped floor แทน ดู `ARCHITECTURE.md`) และตาราง `admin.Users` retire 2026-09-14 — section นี้คงไว้เป็นกับดักสำหรับคนที่ต้อง query dump/DB เก่าหรือ migration ที่ยังมี security policy เท่านั้น.

...
- **Canonical commerce names (merchant-commerce ERD reset):** `Carts.Domain.Items.Item` เก็บ
  ...
  `txn.PspConnections`. IAM catalogกลางมี 25 permissions/7 groups (scope Platform/Merchant/Shared); Active-only resolution.

...
public sealed class OpenApiDocumentTests
{
    ...
    public async Task OpenApi_security_scheme_ids_are_the_published_contract()
    {
        ...
        // generated clients key on — IdentityPlatform + MerchantUserSession + PlatformToken, nothing else. No other test
        ...
        Assert.Equal(["IdentityPlatform", "MerchantUserSession", "PlatformToken"], ids);
    }
}

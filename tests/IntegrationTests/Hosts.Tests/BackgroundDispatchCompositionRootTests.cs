...
public sealed class BackgroundDispatchCompositionRootTests
{
    private sealed class ValidatingFactory : WebApplicationFactory<ApiHost::Program>
    {
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            // This fixture proves scope resolution and DI construction only. Keep production dispatchers
            // registered in the application, but do not start their SQL polling loops against the deliberate
            // unreachable connection used by this host-composition test.

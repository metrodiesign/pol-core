...
/// <summary>
/// First set of in-memory doubles for the Payments handlers (mirrors <c>tests/Pol.UnitTests/Carts.Tests/Fakes.cs</c> and
/// <c>tests/Pol.UnitTests/Orders.Tests/Fakes.cs</c>). The adapter tests drive the REAL adapters over

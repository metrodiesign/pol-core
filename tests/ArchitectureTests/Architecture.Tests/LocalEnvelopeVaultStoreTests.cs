...
/// <c>BuildingBlocks.Tests.LocalEnvelopeVaultStoreTests</c> onto <see cref="ControlPlaneDbContext"/>, task
...
public sealed class LocalEnvelopeVaultStoreTests : IDisposable
{
    ...
    private static LocalEnvelopeVaultStore NewStore(ControlPlaneDbContext db, IClock clock, VaultKeyring keyring) =>

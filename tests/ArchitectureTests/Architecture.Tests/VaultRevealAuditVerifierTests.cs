...
/// <see cref="ControlPlaneDbContext"/>, task 8.5.8 — <see cref="VaultRevealAuditVerifier"/> moved into this
...
public sealed class VaultRevealAuditVerifierTests : IDisposable
{
    ...
    private static void Seed(ControlPlaneDbContext db, int count, string name = "psp-secret")
    {

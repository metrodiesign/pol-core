...
public sealed class BypassPrimitiveTests
{
    ...
    [
        ...
        "src/Infrastructure/Persistence/Persistence.MerchantRuntime/Payments/SessionRepository.cs", // transaction-integrity: GetByIdForUpdateAsync takes a narrow Session Id + ambient MerchantId UPDLOCK/HOLDLOCK, then reloads the tracked row for confirmation apply
        ...
        "src/Infrastructure/Persistence/Persistence.ControlPlane/Payments/MerchantRuntimeAuthorizationLease.cs", // Task10: conditional parameterized acct.Accounts update bound to the caller transaction and exact actor/version predicate

...
public sealed class HostTestConfigGateTests
{
    ...
    private const string CanaryExemption = "tests/IntegrationTests/Hosts.Tests/HostConfigPrecedenceCanaryTests.cs";
    ...
    private const string ProgramCs = "src/Api/Api/Program.cs";

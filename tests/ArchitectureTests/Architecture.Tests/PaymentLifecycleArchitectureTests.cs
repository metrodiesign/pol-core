...
public sealed class PaymentLifecycleArchitectureTests
{
    ...
    public void PaymentConfirmationService_is_only_application_emitter_of_failed_and_expired_transitions()
    {
        ...
        var applicationRoot = Path.Combine(root, "src/Application/Modules/Payments.Application");
    ...
    public void Every_Order_lifecycle_writer_uses_shared_locked_read_primitive()
    {
        ...
        {
            "src/Application/Modules/Orders.Application/CancelOrder.cs",
        ...
        var attach = File.ReadAllText(Path.Combine(
            root, "src/Application/Modules/Payments.Application/CreateSession/CreateSessionHandler.cs"));
        ...
        var orderRepository = File.ReadAllText(Path.Combine(
            root, "src/Infrastructure/Persistence/Persistence.MerchantRuntime/Orders/OrderRepository.cs"));
        var payableOrderReader = File.ReadAllText(Path.Combine(
            root, "src/Infrastructure/Persistence/Persistence.MerchantRuntime/Payments/PayableOrderReader.cs"));

...
public sealed class SaleCodeRenameCompletenessTests
{
    ...
    [
        "tests/ArchitectureTests/Architecture.Tests/SaleCodeRenameCompletenessTests.cs",       // this ban itself
        "src/Api/Api/Program.cs",                                           // multipart/request DTO wire contract

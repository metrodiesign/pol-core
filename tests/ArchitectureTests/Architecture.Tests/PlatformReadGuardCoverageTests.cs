...
{
    private const string ScanRoot = "src/Infrastructure/Persistence/Persistence.MerchantRuntime";
    ...
    private static readonly Dictionary<string, string[]> Allowlist = new()
    {
        ...
        ["src/Infrastructure/Persistence/Persistence.MerchantRuntime/Outbox/OutboxDispatcher.cs"] = ["*"],
        // NEXT VALUE FOR advances sequence state — not a pure read.
        ["src/Infrastructure/Persistence/Persistence.MerchantRuntime/Orders/OrderNoSequence.cs"] = ["NextAsync"],
        // Read-before-write in the same idempotency unit on the webhook path.
        ["src/Infrastructure/Persistence/Persistence.MerchantRuntime/Idempotency/EfIdempotencyStore.cs"] = ["TryBeginAsync"],
        ...
        ["src/Infrastructure/Persistence/Persistence.MerchantRuntime/Orders/DoubleSellAuditor.cs"] = ["*"],
        ...
        ["src/Infrastructure/Persistence/Persistence.MerchantRuntime/Notifications/NotificationDeliveryDispatcher.cs"] = ["ProcessAsync", "RunBatchAsync"],

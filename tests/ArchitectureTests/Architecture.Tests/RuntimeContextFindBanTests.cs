...
/// guarantee. Banned everywhere under <c>src/Infrastructure/Persistence/</c> (the three runtime-context assemblies) — every
...
public sealed class RuntimeContextFindBanTests
{
    ...
    public void No_runtime_context_file_calls_Find_or_FindAsync()
    {
        ...
        var persistenceRoot = Path.Combine(repoRoot, "src", "Infrastructure", "Persistence");
        ...
        Assert.True(offenders.Count == 0,
            "DbSet.Find/FindAsync used inside a runtime-context assembly (src/Infrastructure/Persistence/) — its change-tracker "

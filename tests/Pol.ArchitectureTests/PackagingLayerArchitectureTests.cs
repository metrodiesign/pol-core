...
public sealed class PackagingLayerArchitectureTests
{
    ...
    {
        AssertNoOuterDependency(typeof(SharedKernel.Money).Assembly, "Pol.Domain");
    }

    [Fact]
    public void Application_does_not_depend_on_infrastructure_or_http_host()
    {
        AssertNoOuterDependency(typeof(BuildingBlocks.Application.PagedResult<>).Assembly, "Pol.Application");
    }
    ...
    private static void AssertNoOuterDependency(Assembly assembly, string layer)
    {
        var referencedAssemblies = assembly.GetReferencedAssemblies()
            ...
            .Where(name => name is "Pol.Infrastructure" or "Pol.Api")
            .ToArray();

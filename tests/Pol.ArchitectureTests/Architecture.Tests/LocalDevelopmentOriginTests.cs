...
public sealed class LocalDevelopmentOriginTests
{
    ...
    public void Committed_local_examples_pin_api_and_spa_origins()
    {
        ...
        using var launch = ReadJson(root, "src/Pol.Api/Properties/launchSettings.json");
        ...
        using var settings = ReadJson(root, "src/Pol.Api/appsettings.Development.json.example");

...
public sealed class SaleCodeRenameCompletenessTests
{
    ...
    [
        "tests/Pol.ArchitectureTests/Architecture.Tests/SaleCodeRenameCompletenessTests.cs",       // this ban itself
        "src/Pol.Api/Api/Program.cs",                                           // multipart/request DTO wire contract
        "src/Pol.Api/Api/Merchants/UserRegistration.cs",                        // producerCode -> SaleCode mapper
        "src/Pol.Application/Modules/Merchants.Application/Users/ManageMerchantUsers.cs", // manager edit wire DTO
        "tests/Pol.IntegrationTests/Hosts.Tests/UserRegistrationFormTests.cs",                     // canonical key + legacy key rejection
        "tests/Pol.IntegrationTests/Hosts.Tests/SfsOpenApiTests.cs",                               // published multipart schema
        "tests/Pol.IntegrationTests/Hosts.Tests/RegistrationHistoryEndpointTests.cs"               // history stays saleCode
    ];

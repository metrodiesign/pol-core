...
public sealed class TransactionInventoryTests
{
    ...
    {
        ["src/Pol.Application/Modules/Payments.Application/HandlePspWebhook/HandlePspWebhookHandler.cs"] = 1, // row 21
        ...
        ["src/Pol.Application/Modules/Payments.Application/HandlePspWebhook/InboundWebhookRematcher.cs"] = 1,
        ...
        ["src/Pol.Application/Modules/Payments.Application/CreateSession/CreateSessionHandler.cs"] = 3,
        ...
        ["src/Pol.Application/Modules/Payments.Application/StartRedirect/StartRedirectHandler.cs"] = 1,
        ...
        ["src/Pol.Application/Modules/Orders.Application/CancelOrder.cs"] = 1,
        ["src/Pol.Application/Modules/Orders.Application/OrderPaidConsumer.cs"] = 1,
        ["src/Pol.Application/Modules/Orders.Application/OrderPaymentFailedConsumer.cs"] = 1,
        ["src/Pol.Application/Modules/Orders.Application/OrderPaymentExpiredConsumer.cs"] = 1,
        ["src/Pol.Application/Modules/Admins.Application/Users/UnassignMerchant.cs"] = 1,                       // row 9
        ["src/Pol.Application/Modules/Admins.Application/Users/ReactivateAdmin.cs"] = 1,                        // row 4
        ["src/Pol.Application/Modules/Admins.Application/Users/RevokeAdminSession.cs"] = 1,                     // row 5
        ["src/Pol.Application/Modules/Admins.Application/Users/SelfProvisionSuperAdmin.cs"] = 1,                // row 6
        ["src/Pol.Application/Modules/Admins.Application/Users/CreateScopedAdmin.cs"] = 1,                      // row 3
        ["src/Pol.Application/Modules/Admins.Application/Users/BindInvitedAdmin.cs"] = 1,                       // row 2
        ["src/Pol.Application/Modules/Admins.Application/Users/SuspendAdmin.cs"] = 1,                           // row 8
        ["src/Pol.Application/Modules/Admins.Application/Users/AssignMerchant.cs"] = 1,                         // row 1
        ["src/Pol.Application/Modules/Admins.Application/Users/SetAdminRoles.cs"] = 1,                          // row 7
        ["src/Pol.Application/Modules/Admins.Application/Users/ChangeAdminTier.cs"] = 1,                        // row 23 (task 4)
        ["src/Pol.Application/Modules/Admins.Application/Users/ResolveMicrosoftAdmin.cs"] = 1,                  // Tier 0 resolve/bind/JIT
        ["src/Pol.Application/Modules/Merchants.Application/Users/ApproveReject.cs"] = 2,                    // rows 17+18
        ["src/Pol.Application/Modules/Merchants.Application/Users/SubmitRegistration.cs"] = 1,               // row 20
        ["src/Pol.Application/Modules/Merchants.Application/Users/SetUserRoles.cs"] = 1,                     // row 19
        ["src/Pol.Application/Modules/Merchants.Application/Users/ManageMerchantUsers.cs"] = 4,             // rows 25-28
        ["src/Pol.Application/Modules/Iam.Application/Roles/UpdateRole.cs"] = 1,                                   // row 13
        ["src/Pol.Application/Modules/Iam.Application/Roles/DeleteRole.cs"] = 1,                                   // row 12
        ["src/Pol.Application/Modules/Iam.Application/Roles/CreateRole.cs"] = 1,                                   // row 11
        ["src/Pol.Api/Api/Orders/OrderCreationCoordinator.cs"] = 1,                                    // direct Cart-to-Order shared MerchantRuntime transaction
        ["src/Pol.Infrastructure/Persistence/Persistence.ControlPlane/Governance/GovernanceStore.cs"] = 3,              // rows 29-31
        ["src/Pol.Application/Modules/Orders.Application/OrderWorkflow.cs"] = 6, // order/user idempotent workflows
        ["src/Pol.Application/Modules/Platform.Application/Transactions/CheckoutTransactionService.cs"] = 8, // neutral cross-module transaction orchestrator
        ["src/Pol.Infrastructure/Persistence/Persistence.ControlPlane/Merchants/AdminMerchantControlStore.cs"] = 7, // rows 32-33 plus merchant master writes
        ["src/Pol.Infrastructure/Persistence/Persistence.ControlPlane/Payments/AdminPaymentsControlStore.cs"] = 16, // all Admin payment mutations lease-covered (incl. simple-routing set task 5, candidate credential test task 6, environment change task 7)
        ["src/Pol.Infrastructure/Persistence/Persistence.ControlPlane/Payments/Capabilities/EffectivePaymentCapabilityResolver.cs"] = 1, // request-scoped authorization snapshot
        ["src/Pol.Infrastructure/Persistence/Persistence.ControlPlane/Payments/Capabilities/PaymentCapabilityMigrationService.cs"] = 3, // backfill, cutover, rollback
        ["src/Pol.Infrastructure/Persistence/Persistence.ControlPlane/Payments/LegacyPaymentRemediationService.cs"] = 2, // task 9 offline remediation: env backfill + per-merchant legacy-snapshot upgrade write phase
        ["src/Pol.Infrastructure/Persistence/Persistence.ControlPlane/Payments/AdminPaymentsApprovalExecutor.cs"] = 3, // rows 38-39 + environment activation (task 7)
        ["src/Pol.Infrastructure/Persistence/Persistence.MerchantRuntime/Idempotency/AdminOperationExecutor.cs"] = 3, // row 40: atomic flow + recoverable claim/result
        ["src/Pol.Infrastructure/Persistence/Persistence.ControlPlane/IdentityAccess/AgentRegistrationStore.cs"] = 4, // registration case/attempt/decision transactions
        ["src/Pol.Infrastructure/Persistence/Persistence.ControlPlane/IdentityAccess/IdentityAccessStore.cs"] = 1, // account/access atomic identity flow
        ["src/Pol.Infrastructure/Persistence/Persistence.MerchantRuntime/Notifications/NotificationDeliveryDispatcher.cs"] = 2, // bounded delivery claim/retry transactions
        ["src/Pol.Infrastructure/Persistence/Persistence.MerchantRuntime/Notifications/NotificationMaterializer.cs"] = 1, // notification inbox/materialization transaction
        ["src/Pol.Infrastructure/Persistence/Persistence.MerchantRuntime/Notifications/NotificationOperations.cs"] = 3, // notification retry/receipt/review transactions
        ["src/Pol.Infrastructure/Persistence/Persistence.ControlPlane/Governance/ControlPlaneOperationExecutor.cs"] = 1, // row 41
        ["src/Pol.Infrastructure/Persistence/Persistence.ControlPlane/Iam/ApiClientApprovalExecutor.cs"] = 1, // row 42
        ["src/Pol.Infrastructure/Persistence/Persistence.ControlPlane/Iam/ApiClientStore.cs"] = 1, // row 43
        ["src/Pol.Infrastructure/Persistence/Persistence.ControlPlane/Notifications/DeliveryStore.cs"] = 2, // rows 44-45
        ["src/Pol.Infrastructure/Persistence/Persistence.ControlPlane/Admins/WorkforceTenantBindingStore.cs"] = 1, // boot-time tenant singleton
    };
    ...
    [
        "src/Pol.Infrastructure/Persistence/Persistence.ControlPlane/Admins/ControlPlaneUnitOfWork.cs",
        "src/Pol.Infrastructure/Persistence/Persistence.MerchantRuntime/MerchantRuntimeUnitOfWork.cs",
        "src/Pol.Infrastructure/Persistence/Persistence.MerchantUsers/Users/MerchantUserRepositories.cs",
    ];
    ...
    {
        ["src/Pol.Infrastructure/Persistence/Persistence.ControlPlane/Vault/VaultAuditAppender.cs"] = 1,
        ...
        ["src/Pol.Infrastructure/Persistence/Persistence.Provisioning/ProvisioningCoordinator.cs"] = 1,
        ["src/Pol.Infrastructure/Persistence/Persistence.ControlPlane/Notifications/WebhookDeliveryDispatcher.cs"] = 1, // row 46
        ["src/Pol.Infrastructure/Persistence/Persistence.ControlPlane/IdentityAccess/IdentityAccessStore.cs"] = 2, // account/access atomic identity flows
        ["src/Pol.Infrastructure/BuildingBlocks.Infrastructure/Migration/SqlMigrationMaintenanceLease.cs"] = 1, // Task9 writer lease
        ["src/Pol.Infrastructure/BuildingBlocks.Infrastructure/Migration/SqlMigrationReadinessStore.cs"] = 2, // Task9 durable rehearsal writes
        ...
        ["src/Pol.Infrastructure/Tools/WorkforceIdentityMigrator/Program.cs"] = 2,
    };

...
public sealed class HostTestConfigGateTests
{
    ...
    private const string CanaryExemption = "tests/Pol.IntegrationTests/Hosts.Tests/HostConfigPrecedenceCanaryTests.cs";
    ...
    private const string ProgramCs = "src/Pol.Api/Api/Program.cs";

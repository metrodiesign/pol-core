...
public sealed class AdminApprovalWriteAuthorizerTests
{
    ...
    [Fact]
    public void Payment_security_foundation_has_no_removed_lease_projection_write_surface()
    {
        ...
        Assert.DoesNotContain(source, text => text.Contains("AdminAuthorizationLeaseRow", StringComparison.Ordinal));
    }
}

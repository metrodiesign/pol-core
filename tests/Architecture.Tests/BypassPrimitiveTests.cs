...
public sealed class BypassPrimitiveTests
{
    ...
    [
        ...
        "src/Persistence/Persistence.ControlPlane/Admins/EmployeeProfileReader.cs", // tier0-graph-employee-profile task 2: read-only parameterised SELECT TOP (2) on the operator-loaded HR mirror tables cfg.VibEmp/cfg.branch (not EF entities); Offices/Divisions stay normal EF queries

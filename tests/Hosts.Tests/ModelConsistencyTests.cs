...
// REQ-9.3 / design "Migration strategy": the 3-migration chain (InitialSchema + SecurityObjects + SeedData) plus
...
public sealed class ModelConsistencyTests
{
    ...
    public void Model_has_no_pending_changes_against_the_migration_snapshot()
    {
        ...
        Assert.False(
            ...
            "(migrations remove down the chain, then re-add InitialSchema/SecurityObjects/SeedData) so the " +

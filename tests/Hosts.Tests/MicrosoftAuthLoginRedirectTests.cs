...
file sealed class MicrosoftLoginFactory : WebApplicationFactory<ApiHost::Program>
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.UseSetting("MerchantUserAuth:Providers:Microsoft:Authority", "https://login.microsoftonline.com/organizations/v2.0");
        builder.UseSetting("MerchantUserAuth:Providers:Microsoft:ClientId", MerchantClientId);
        builder.UseSetting("MerchantUserAuth:Providers:Microsoft:ClientSecret", "test-secret");
        builder.UseSetting("MerchantUserAuth:Providers:Microsoft:CallbackPath", "/api/v1/merchants/auth/microsoft/callback");
...
public sealed class MicrosoftAuthLoginRedirectTests
{
        ...
        string loginPath, string clientId, string callbackPath)
    {
        ...
        Assert.Equal("openid email", query["scope"].ToString());

...
/// <summary>
/// The merchant-user registration wire-ticket protector (REQ-3.1/14.4): a ticket roundtrips through Protect/Unprotect
...
public sealed class MerchantUserRegistrationTicketsTests
{
    ...
    public void A_token_sealed_under_a_different_purpose_cannot_be_unprotected_here()
    {
        ...
        var foreign = provider.CreateProtector("MerchantUser.SomethingElse.v1").ToTimeLimitedDataProtector();
